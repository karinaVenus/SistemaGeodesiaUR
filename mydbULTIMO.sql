...
('ART01', 'cinta de tela', 2, 1, 1, 43, 'img.jpg', 1),
...
(2, '2022-04-24 22:44:56', 1, 'ART01', '60.00', 7),
...
(95, 2, 1, 2, 3, 4, '45345346', '2022-05-18', '2022-05-31 01:28:30', 1, NULL);
...
--
ALTER TABLE `presentacion`
  MODIFY `cod_pres` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `reg_ing_cab`
  MODIFY `cod_reg_in` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;

--
-- AUTO_INCREMENT de la tabla `reg_sal_cab`
--
ALTER TABLE `reg_sal_cab`
  MODIFY `cod_reg_sal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=96;
