...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-05-2022 a las 23:09:49
...
--
-- Estructura de tabla para la tabla `articulo_caracteristica`
--

CREATE TABLE `articulo_caracteristica` (
  `cod_art` varchar(12) NOT NULL,
  `cod_caracteristica` int(11) NOT NULL,
  `valor_caracteristica` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `caracteristica` (
  `cod_caracteristica` int(11) NOT NULL,
  `des_caracteristica` varchar(35) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `centro_costo` (
  `cod_centro_costo` int(11) NOT NULL,
  `des_centro_costo` varchar(45) DEFAULT NULL,
  `cod_responsable` int(11) DEFAULT NULL,
  `estado_cc` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `estado_requerimiento`
--

CREATE TABLE `estado_requerimiento` (
  `cod_estado_req` int(11) NOT NULL,
  `des_estado_req` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `estado_requerimiento`
--

INSERT INTO `estado_requerimiento` (`cod_estado_req`, `des_estado_req`) VALUES
(1, 'Elaborado'),
(2, 'Revisado'),
(3, 'Aprobado');
...
--
-- Estructura de tabla para la tabla `orden_req_cab`
--

CREATE TABLE `orden_req_cab` (
  `cod_ord_req` int(11) NOT NULL,
  `nro_req` varchar(15) DEFAULT NULL,
  `cod_trabajador` int(11) DEFAULT NULL,
  `cod_almacen` int(11) DEFAULT NULL,
  ...
  `cod_estado_req` int(11) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `orden_req_det`
--

CREATE TABLE `orden_req_det` (
  `cod_ord_req` int(11) NOT NULL,
  `cod_art` varchar(12) NOT NULL,
  `can_art` int(11) DEFAULT NULL,
  `obs_ord_req` varchar(350) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `orden_req_historico`
--

CREATE TABLE `orden_req_historico` (
  `cod_historico` int(11) NOT NULL,
  `cod_ord_req` int(11) NOT NULL,
  `cod_estado_req` int(11) DEFAULT NULL,
  `cod_usuario` int(11) DEFAULT NULL,
  `fec_estado` datetime DEFAULT NULL,
  `Obs_estado` varchar(350) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Indices de la tabla `articulo_caracteristica`
--
ALTER TABLE `articulo_caracteristica`
  ADD PRIMARY KEY (`cod_art`,`cod_caracteristica`),
  ADD KEY `fk_caract_art_idx` (`cod_caracteristica`);
...
ALTER TABLE `centro_costo`
  ADD PRIMARY KEY (`cod_centro_costo`),
  ADD KEY `fk_cc_resp_idx` (`cod_responsable`);
...
--
-- Indices de la tabla `estado_requerimiento`
--
ALTER TABLE `estado_requerimiento`
  ADD PRIMARY KEY (`cod_estado_req`);
...
--
-- Indices de la tabla `orden_req_cab`
--
ALTER TABLE `orden_req_cab`
  ADD PRIMARY KEY (`cod_ord_req`),
  ADD KEY `fk_req_cc_idx` (`cod_centro_costo`),
  ADD KEY `fk_req_estado_idx` (`cod_estado_req`),
  ADD KEY `fk_req_trab_idx` (`cod_trabajador`),
  ADD KEY `fk_req_alm_idx` (`cod_almacen`),
  ADD KEY `fk_req_soli_idx` (`cod_solicitador`);

--
-- Indices de la tabla `orden_req_det`
--
ALTER TABLE `orden_req_det`
  ADD PRIMARY KEY (`cod_ord_req`,`cod_art`),
  ADD KEY `fk_req_det_art_idx` (`cod_art`);

--
-- Indices de la tabla `orden_req_historico`
--
ALTER TABLE `orden_req_historico`
  ADD PRIMARY KEY (`cod_historico`,`cod_ord_req`),
  ADD KEY `fk_his_estado_idx` (`cod_estado_req`),
  ADD KEY `fk_his_usu_idx` (`cod_usuario`),
  ADD KEY `fk_his_ord` (`cod_ord_req`);
...
ALTER TABLE `reg_sal_cab`
  ...
  ADD KEY `fk_sal_trab_idx` (`cod_trabajador`),
...
--
ALTER TABLE `centro_costo`
  MODIFY `cod_centro_costo` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `estado_requerimiento`
--
ALTER TABLE `estado_requerimiento`
  MODIFY `cod_estado_req` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT de la tabla `orden_req_cab`
--
ALTER TABLE `orden_req_cab`
  MODIFY `cod_ord_req` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `orden_req_historico`
--
ALTER TABLE `orden_req_historico`
...
--
-- Filtros para la tabla `articulo_caracteristica`
--
ALTER TABLE `articulo_caracteristica`
  ADD CONSTRAINT `fk_art_caract` FOREIGN KEY (`cod_art`) REFERENCES `articulo` (`cod_art`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_caract_art` FOREIGN KEY (`cod_caracteristica`) REFERENCES `caracteristica` (`cod_caracteristica`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `centro_costo`
--
ALTER TABLE `centro_costo`
  ADD CONSTRAINT `fk_cc_resp` FOREIGN KEY (`cod_responsable`) REFERENCES `trabajador` (`cod_trabajador`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
-- Filtros para la tabla `orden_req_cab`
--
ALTER TABLE `orden_req_cab`
  ADD CONSTRAINT `fk_req_alm` FOREIGN KEY (`cod_almacen`) REFERENCES `almacen` (`cod_almacen`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_req_cc` FOREIGN KEY (`cod_centro_costo`) REFERENCES `centro_costo` (`cod_centro_costo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_req_estado` FOREIGN KEY (`cod_estado_req`) REFERENCES `estado_requerimiento` (`cod_estado_req`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_req_soli` FOREIGN KEY (`cod_solicitador`) REFERENCES `trabajador` (`cod_trabajador`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_req_trab` FOREIGN KEY (`cod_trabajador`) REFERENCES `trabajador` (`cod_trabajador`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `orden_req_det`
--
ALTER TABLE `orden_req_det`
  ADD CONSTRAINT `fk_req_det_art` FOREIGN KEY (`cod_art`) REFERENCES `articulo` (`cod_art`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_req_det_req` FOREIGN KEY (`cod_ord_req`) REFERENCES `orden_req_cab` (`cod_ord_req`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `orden_req_historico`
--
ALTER TABLE `orden_req_historico`
  ADD CONSTRAINT `fk_his_estado` FOREIGN KEY (`cod_estado_req`) REFERENCES `estado_requerimiento` (`cod_estado_req`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_his_ord` FOREIGN KEY (`cod_ord_req`) REFERENCES `orden_req_cab` (`cod_ord_req`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_his_usu` FOREIGN KEY (`cod_usuario`) REFERENCES `usuario` (`cod_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `reg_sal_cab`
  ...
  ADD CONSTRAINT `fk_sal_trab` FOREIGN KEY (`cod_trabajador`) REFERENCES `trabajador` (`cod_trabajador`) ON DELETE NO ACTION ON UPDATE NO ACTION,
